    ...
    return (
        <header className="text-gray-600 body-font mt-20">
            <div className="bg-[#5b4b45] flex flex-wrap flex-col md:flex-row items-center px-5 py-5 fixed top-0 left-0 right-0">
                ...
                <a
                href='#img' className="flex order-first lg:order-none cursor-default lg:w-1/5 title-font font-medium items-center text-gray-900 lg:items-center lg:justify-center mb-4 md:mb-0">
